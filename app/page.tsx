...
export default function Home() {
  return (
    <main >
      <section className='grid shadow-xl shadow-gray-400 p-3 bg-white rounded-3xl' >
        ...
        <div className='w-[18.75rem]  mt-5 px-5'>
          ...
          <p className='text-xl leading-tight	 text-center font-[650] opacity-40 my-5'>Scan the QR code to visit Frontend Mentor and take your coding skills to the next level</p>
        </div>
      </section>
