  ...
  return (
    <main >
      <section className='grid shadow-xl p-3 bg-white rounded-3xl' >
        <Image height={300} width={300} className='rounded-3xl' src={qrr} alt="Qr de ejemplo" />
        <div className='w-[18.75rem]  mt-5 px-5'>
          ...
          <p className='leading-tight	 text-center font-semibold opacity-40 my-5'>Scan the QR code to visit Frontend Mentor and take your coding skills to the next level</p>
        </div>
      </section>
