    ...
    <main >
      <section className='grid shadow-xl p-3 bg-white rounded-3xl' >
        ...
        <div className='w-[18.75rem]  mt-5 px-5'>
          ...
          <p className='leading-tight text-sm	 text-center font-medium opacity-40 my-5'>Scan the QR code to visit Frontend Mentor and take your coding skills to the next level</p>
        </div>
      </section>
